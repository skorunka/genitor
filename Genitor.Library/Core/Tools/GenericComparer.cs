namespace Genitor.Library.Core.Tools
{
	...
	public sealed partial class GenericComparer<T> : IComparer<T>
	{
		...
		/// Sorting order.
		/// </summary>
		public SortOrder SortingOrder => this._sortingOrder;
		...
		{
			var propertyInfo = typeof(T).GetProperty(this._sortColumn);
			var obj1 = (IComparable)propertyInfo.GetValue(x, null);
			var obj2 = (IComparable)propertyInfo.GetValue(y, null);
			return this._sortingOrder == SortOrder.Ascending ? obj1.CompareTo(obj2) : obj2.CompareTo(obj1);
		}
